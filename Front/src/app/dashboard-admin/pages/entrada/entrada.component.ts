...
export class EntradaComponent implements OnInit {
  ...
  constructor(private modalService: ModalService,   private aes: AesService, private EntradaService : EntradaService, private router: Router) {
  ...
  ngOnInit(): void {
     ...
     this.EntradaService.GetAllProductos().subscribe({
      next: (data: any) => {
 ...
 productosFechas(IdProducto: number)
 {
  ...
  this.EntradaService.GetAllProductosFechaByIdProducto(IdProducto).subscribe({
    next: (data: any) => {
      console.log(data.result);
      if (data.isSuccess)
        {
  ...
  addOreditTarea() {
    ...
    if (data.fechaVence == null)
      ...
      this.EntradaService.InsertEntrada(data).subscribe({
        next: (data: any) => {
          console.log(data.result);
